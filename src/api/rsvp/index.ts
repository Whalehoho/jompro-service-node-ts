...
router.get('/getApprovedByAccountId/:userId', controller.getApprovedByAccountId);
router.get('/getPendingByEventId/:eventId', controller.getPendingByEventId);
router.get('/getByEventIdAndAccountId/:eventId/:userId', controller.getByEventIdAndAccountId);
